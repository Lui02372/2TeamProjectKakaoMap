...
agent_router = APIRouter(tags=["01 · LLM"])
structured_output_router = APIRouter(tags=["02 · Structured Output"])
...
@structured_output_router.post("/api/prompts/preview", response_model=PromptPreviewResult)
...
@structured_output_router.post("/api/structured/validate", response_model=StructuredValidationResult)
...
@structured_output_router.post("/api/structured/generate", response_model=StructuredOutputResult)
@structured_output_router.post(
...
@structured_output_router.post("/api/structured/compare", response_model=StructuredCompareResult)
