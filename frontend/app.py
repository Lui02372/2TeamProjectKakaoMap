...
travel_map_page = st.Page("app_pages/12_travel_kakaomap.py", title="여행 지도 Agent")

navigation = st.navigation(
    [home_page, travel_map_page, concept_page, travel_page, environment_page, llm_page, provider_page,
...
with st.sidebar:
    ...
    with st.expander("02. Prompt와 구조화 출력", expanded=True):
        ...
        st.page_link(travel_map_page, label="2-4. 여행 지도 Agent")
